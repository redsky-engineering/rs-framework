...
## [2.0.3](https://github.com/redsky-engineering/rs-framework/compare/v2.0.2...v2.0.3) (2026-05-12)

## [2.0.2](https://github.com/redsky-engineering/rs-framework/compare/v2.0.1...v2.0.2) (2026-05-12)

## [2.0.1](https://github.com/redsky-engineering/rs-framework/compare/v2.0.0...v2.0.1) (2026-05-12)

## [2.0.0](https://gitlab.com/redsky_public/framework/compare/v1.7.0...v2.0.0) (2026-05-12)

### Features

- **DataTable:** Ability to set initial rows per page, fixed issue with double requests on initial load ([9f17e96](https://gitlab.com/redsky_public/framework/commit/9f17e96c08149e88ab49da9add3a17a2669fb5ab))
- update package dependencies and imports ([b9a9875](https://gitlab.com/redsky_public/framework/commit/b9a9875977e9384dbe93a02c916e1b4904460eb5))
...
- **all:** Updates to FC child props to help support react 18 ([b091ae0](https://gitlab.com/redsky_public/framework/commit/b091ae081d88fa677c3a9812446d4a38d9f67220))
...
- **hook:** Fixed initial use of useCurrentPath() ([62eddec](https://gitlab.com/redsky_public/framework/commit/62eddec35835a46056bc0e6bdd3e10c508f9da88))
